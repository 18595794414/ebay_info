...
class SavePipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        if isinstance(item, EbayItemShop):
            ...
            if self.count1 % 1000 == 0 and self.count1 != 0:
                self.file_num1 += 1
            with open(r'W:/Gc/shopinfo.txt', 'a', encoding='utf-8') as f:
                f.write(str(data) + '\n')
            with open(r'W:/Gc/shop_html/ebay_shop_{}.html'.format(self.file_num1), 'a', encoding='utf-8') as f:
                f.write(item['html'])
            self.count1 += 1
        ...
        # 商品详情信息
            ...
            if self.count2 % 1000 == 0 and self.count2 != 0:
                self.file_num2 += 1
            with open(r'W:/Gc/shopinfo.txt', 'a', encoding='utf-8') as f:
                f.write(str(data) + '\n')
            with open(r'W:/Gc/shop_html/ebay_shop_{}.html'.format(self.file_num2), 'a', encoding='utf-8') as f:
                f.write(item['html'])
            self.count2 += 1
